...
public class IndiaCases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Covid Cases: India");
        ...
        pieChart = findViewById(R.id.india_cases_piechart);
        swipeRefreshLayout = findViewById(R.id.india_cases_swipe_refresh_layout);
    ...
    public void stateData(View view) {
